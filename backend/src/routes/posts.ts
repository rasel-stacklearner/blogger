...
router.get(
  ...
  async (req: Request, res: Response): Promise<any> => {
    ...
    try {
      ...
      // If not in cache, perform complex query
      ...
      // Transform the result to a more organized structure
      ...
      logger.info("Cache miss for post details - data fetched from database");
